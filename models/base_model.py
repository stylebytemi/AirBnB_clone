...
class BaseModel:
    ...
    Methods:
        _str_: prints the class name, id, and creates dictionary
        ...
        if not kwargs:
            ...
            for key, value in kwargs.items():
                if key in ("updated_at", "created_at"):
                    self._dict_[key] = datetime.strptime(
                        value, DATE_TIME_FORMAT)
                elif key[0] == "id":
                    self._dict_[key] = str(value)
                else:
    ...
    def to_dict(self):
        ...
        keys/values of _dict_ instance
        """
        map_objects = {}
        ...
        map_objects["_class"] = self.class.name_
        return map_objects
